...
typedef VecSimQueryResult* (*Index_DistnaceKQuery)(VecSimIndex* index, const void* queryBlob, float distance);
...
VecSimQueryResult* VecSimIndex_DistnaceKQuery(VecSimIndex* index, const void* queryBlob, float distance);
