...
VecSimQueryResults *BruteForce_TopKQuery(VecSimIndex *index, const void *queryBlob, size_t k,
                                        VecSimQueryParams *queryParams);

// TODO

VecSimQueryResults *BruteForce_DistanceQuery(VecSimIndex *index, const void *queryBlob,
