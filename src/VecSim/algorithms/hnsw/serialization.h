...
public:
    // Wrap hnsw index.
    explicit HNSWIndexSerializer(HNSWIndex<DataType, DistType> *hnsw_index);
    ...
    void reset(HNSWIndex<DataType, DistType> *hnsw_index = nullptr);
};
...
template <typename DataType, typename DistType>
void HNSWIndexSerializer<DataType, DistType>::saveIndexFields(std::ofstream &output) {
...
template <typename DataType, typename DistType>
void HNSWIndexSerializer<DataType, DistType>::saveGraph(std::ofstream &output) {
...
template <typename DataType, typename DistType>
void HNSWIndexSerializer<DataType, DistType>::loadIndex_v1(std::ifstream &input) {
    this->restoreIndexFields(input);
    this->restoreGraph(input);
}

template <typename DataType, typename DistType>
void HNSWIndexSerializer<DataType, DistType>::restoreIndexFields(std::ifstream &input) {
...
template <typename DataType, typename DistType>
void HNSWIndexSerializer<DataType, DistType>::restoreGraph(std::ifstream &input) {
...
template <typename DataType, typename DistType>
void HNSWIndexSerializer<DataType, DistType>::loadIndex(const std::string &location) {
...
template <typename DataType, typename DistType>
HNSWIndexMetaData HNSWIndexSerializer<DataType, DistType>::checkIntegrity() {
