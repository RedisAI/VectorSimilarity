...
INDEX_TEST_FRIEND_CLASS(HNSWTieredIndexTest_tieredSnapshotRepairRunsHorizonRecycles_Test)
INDEX_TEST_FRIEND_CLASS(HNSWTieredIndexTest_parallelBatchIteratorSearchSnapshot_Test)
