...
using candidatesMinHeap = vecsim_stl::min_priority_queue<idType, float>;
using candidatesMaxHeap = vecsim_stl::max_priority_queue<idType, float>;
...
private:
    ...
    prepareResults(vecsim_stl::max_priority_queue<idType, float> top_candidates, size_t n_res);
