...
extern "C" VecSimQueryResult_Collection *BruteForce_TopKQuery(VecSimIndex *index,
...
extern "C" VecSimQueryResult_Collection *BruteForce_DistanceQuery(VecSimIndex *index,
