...
class OLDHNSWSingle_BatchIterator : public OLDHNSW_BatchIterator<DataType, DistType> {
private:
...
public:
    OLDHNSWSingle_BatchIterator(void *query_vector, const OLDHNSWIndex<DataType, DistType> *index,
                                VecSimQueryParams *queryParams,
                                std::shared_ptr<VecSimAllocator> allocator)
        : OLDHNSW_BatchIterator<DataType, DistType>(query_vector, index, queryParams, allocator) {}

    ~OLDHNSWSingle_BatchIterator() override {}
};

/******************** Implementation **************/

template <typename DataType, typename DistType>
VecSimQueryResult_List OLDHNSWSingle_BatchIterator<DataType, DistType>::prepareResults(
...
template <typename DataType, typename DistType>
void OLDHNSWSingle_BatchIterator<DataType, DistType>::fillFromExtras(
...
template <typename DataType, typename DistType>
void OLDHNSWSingle_BatchIterator<DataType, DistType>::updateHeaps(
