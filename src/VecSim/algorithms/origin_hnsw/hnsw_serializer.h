...
OLDHNSWIndex<DataType, DistType>::OLDHNSWIndex(std::ifstream &input, const HNSWParams *params,
...
template <typename DataType, typename DistType>
void OLDHNSWIndex<DataType, DistType>::saveIndexIMP(std::ofstream &output) {
    this->saveIndexFields(output);
    this->saveGraph(output);
}

template <typename DataType, typename DistType>
void OLDHNSWIndex<DataType, DistType>::fieldsValidation() const {
...
template <typename DataType, typename DistType>
void OLDHNSWIndex<DataType, DistType>::restoreIndexFields(std::ifstream &input) {
...
template <typename DataType, typename DistType>
void OLDHNSWIndex<DataType, DistType>::HandleLevelGenerator(std::ifstream &input) {
    if (this->m_version == EncodingVersion_V1) {
...
template <typename DataType, typename DistType>
void OLDHNSWIndex<DataType, DistType>::restoreGraph_V1_fixes() {
...
template <typename DataType, typename DistType>
void OLDHNSWIndex<DataType, DistType>::restoreGraph(std::ifstream &input) {
...
template <typename DataType, typename DistType>
void OLDHNSWIndex<DataType, DistType>::saveIndexFields_v2(std::ofstream &output) const {
...
template <typename DataType, typename DistType>
void OLDHNSWIndex<DataType, DistType>::saveIndexFields(std::ofstream &output) const {
...
template <typename DataType, typename DistType>
void OLDHNSWIndex<DataType, DistType>::saveGraph(std::ofstream &output) const {
