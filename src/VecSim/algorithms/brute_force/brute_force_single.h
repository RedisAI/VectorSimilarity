...
protected:
    ...
    getNewMinMaxPriorityQueue() const override {
        return std::unique_ptr<vecsim_stl::abstract_min_max_heap<pair<DistType, labelType>>>(new (
            this->allocator) vecsim_stl::min_max_heap<pair<DistType, labelType>>(this->allocator));
    }
