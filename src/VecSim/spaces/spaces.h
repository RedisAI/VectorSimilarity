...
void SetDistFunc(VecSimMetric metric, size_t dim, VecSimType type,
                 dist_func_t<float> *index_dist_func, unsigned char *alignment);
void SetDistFunc(VecSimMetric metric, size_t dim, VecSimType type,
                 dist_func_t<double> *index_dist_func, unsigned char *alignment);
