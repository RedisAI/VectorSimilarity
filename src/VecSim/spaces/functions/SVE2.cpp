...
dist_func_t<float> Choose_SQ8_FP16_IP_implementation_SVE2(size_t dim) {
    return dispatch_by_sve_residual<dist_func_t<float>>(
        dim, svcnth(), []<bool partial_chunk, size_t additional_steps>() {
            return SQ8_FP16_InnerProductSIMD_SVE2<partial_chunk, additional_steps>;
        });
}
...
dist_func_t<float> Choose_SQ8_FP16_Cosine_implementation_SVE2(size_t dim) {
    return dispatch_by_sve_residual<dist_func_t<float>>(
        dim, svcnth(), []<bool partial_chunk, size_t additional_steps>() {
            return SQ8_FP16_CosineSIMD_SVE2<partial_chunk, additional_steps>;
        });
}
...
dist_func_t<float> Choose_SQ8_FP16_L2_implementation_SVE2(size_t dim) {
    return dispatch_by_sve_residual<dist_func_t<float>>(
        dim, svcnth(), []<bool partial_chunk, size_t additional_steps>() {
            return SQ8_FP16_L2SqrSIMD_SVE2<partial_chunk, additional_steps>;
        });
}
