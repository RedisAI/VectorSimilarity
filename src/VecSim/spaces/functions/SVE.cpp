...
dist_func_t<float> Kernel<Metric::L2, DataType::SQ8_FP32, Tier::SVE>::make(size_t dim) {
    dist_func_t<float> ret_dist_func;
    CHOOSE_SVE_IMPLEMENTATION(ret_dist_func, SQ8_FP32_L2SqrSIMD_SVE, dim, svcntw);
    return ret_dist_func;
}

dist_func_t<float> Kernel<Metric::IP, DataType::SQ8_FP32, Tier::SVE>::make(size_t dim) {
    dist_func_t<float> ret_dist_func;
    CHOOSE_SVE_IMPLEMENTATION(ret_dist_func, SQ8_FP32_InnerProductSIMD_SVE, dim, svcntw);
    return ret_dist_func;
}

dist_func_t<float> Kernel<Metric::Cosine, DataType::SQ8_FP32, Tier::SVE>::make(size_t dim) {
    dist_func_t<float> ret_dist_func;
    CHOOSE_SVE_IMPLEMENTATION(ret_dist_func, SQ8_FP32_CosineSIMD_SVE, dim, svcntw);
    return ret_dist_func;
}
