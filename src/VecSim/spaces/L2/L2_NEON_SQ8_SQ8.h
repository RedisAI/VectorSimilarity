...
// Helper function to perform L2 squared step for 4 elements with dual dequantization
static inline void SQ8_SQ8_L2SqrStep_NEON(const uint8_t *&pVec1, const uint8_t *&pVec2,
    ...
    // Compute difference
    float32x4_t diff = vsubq_f32(v1_dequant, v2_dequant);
...
float SQ8_SQ8_L2SqrSIMD16_NEON(const void *pVec1v, const void *pVec2v, size_t dimension) {
    ...
    for (size_t i = 0; i < num_of_chunks; i++) {
        SQ8_SQ8_L2SqrStep_NEON(pVec1, pVec2, sum0, min_val_vec1, delta_vec1, min_val_vec2,
                               delta_vec2);
        SQ8_SQ8_L2SqrStep_NEON(pVec1, pVec2, sum1, min_val_vec1, delta_vec1, min_val_vec2,
                               delta_vec2);
        SQ8_SQ8_L2SqrStep_NEON(pVec1, pVec2, sum2, min_val_vec1, delta_vec1, min_val_vec2,
                               delta_vec2);
        SQ8_SQ8_L2SqrStep_NEON(pVec1, pVec2, sum3, min_val_vec1, delta_vec1, min_val_vec2,
                               delta_vec2);
    }
