...
float UINT8_L2SqrSIMD16_NEON_DOTPROD_Chunked(const void *pVect1v, const void *pVect2v,
    ...
    return static_cast<float>(
        spaces::uint8_chunked_total<UINT8_L2ChunkKernel_NEON_DOTPROD<residual>>(pVect1v, pVect2v,
                                                                                dimension));
}
