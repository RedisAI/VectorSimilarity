...
float f_L2SqrSIMD16ExtResiduals_AVX(const void *pVect1v, const void *pVect2v, const void *qty_ptr) {
    size_t qty = *((size_t *)qty_ptr);
    size_t qty16 = qty >> 4 << 4;
    float res = f_L2SqrSIMD16Ext_AVX(pVect1v, pVect2v, &qty16);
...
float f_L2SqrSIMD4ExtResiduals_AVX(const void *pVect1v, const void *pVect2v, const void *qty_ptr) {
    size_t qty = *((size_t *)qty_ptr);
    size_t qty4 = qty >> 2 << 2;
    float res = f_L2SqrSIMD4Ext_AVX(pVect1v, pVect2v, &qty4);
...
double d_L2SqrSIMD16ExtResiduals_AVX(const void *pVect1v, const void *pVect2v,
                                     const void *qty_ptr) {
    return 0;
}
