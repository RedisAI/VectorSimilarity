 ...
 */
 ...
 static inline void L2SquareStep_x4(int8_t *&pVect1, int8_t *&pVect2, int32x4_t &sum0,
                                    int32x4_t &sum1, int32x4_t &sum2, int32x4_t &sum3) {
     // Load 64 int8 elements (64 bytes) at once
     ...
     // Process third chunk
     int8x8_t v1_low_2 = vget_low_s8(v1.val[2]);
     int8x8_t v1_high_2 = vget_high_s8(v1.val[2]);
     int8x8_t v2_low_2 = vget_low_s8(v2.val[2]);
     int8x8_t v2_high_2 = vget_high_s8(v2.val[2]);
 
     int16x8_t v1_low_wide_2 = vmovl_s8(v1_low_2);
     int16x8_t v1_high_wide_2 = vmovl_s8(v1_high_2);
     int16x8_t v2_low_wide_2 = vmovl_s8(v2_low_2);
     int16x8_t v2_high_wide_2 = vmovl_s8(v2_high_2);
 
     int16x8_t diff_low_2 = vsubq_s16(v1_low_wide_2, v2_low_wide_2);
     int16x8_t diff_high_2 = vsubq_s16(v1_high_wide_2, v2_high_wide_2);
 
     int32x4_t diff_low_20 = vmovl_s16(vget_low_s16(diff_low_2));
     int32x4_t diff_low_21 = vmovl_s16(vget_high_s16(diff_low_2));
     int32x4_t diff_high_20 = vmovl_s16(vget_low_s16(diff_high_2));
     int32x4_t diff_high_21 = vmovl_s16(vget_high_s16(diff_high_2));
 
     int32x4_t square_low_20 = vmulq_s32(diff_low_20, diff_low_20);
     int32x4_t square_low_21 = vmulq_s32(diff_low_21, diff_low_21);
     int32x4_t square_high_20 = vmulq_s32(diff_high_20, diff_high_20);
     int32x4_t square_high_21 = vmulq_s32(diff_high_21, diff_high_21);
 
     sum2 = vaddq_s32(sum2, square_low_20);
     sum2 = vaddq_s32(sum2, square_low_21);
     sum2 = vaddq_s32(sum2, square_high_20);
     sum2 = vaddq_s32(sum2, square_high_21);
 
     // Process fourth chunk
     int8x8_t v1_low_3 = vget_low_s8(v1.val[3]);
     int8x8_t v1_high_3 = vget_high_s8(v1.val[3]);
     int8x8_t v2_low_3 = vget_low_s8(v2.val[3]);
     int8x8_t v2_high_3 = vget_high_s8(v2.val[3]);
 
     int16x8_t v1_low_wide_3 = vmovl_s8(v1_low_3);
     int16x8_t v1_high_wide_3 = vmovl_s8(v1_high_3);
     int16x8_t v2_low_wide_3 = vmovl_s8(v2_low_3);
     int16x8_t v2_high_wide_3 = vmovl_s8(v2_high_3);
 
     int16x8_t diff_low_3 = vsubq_s16(v1_low_wide_3, v2_low_wide_3);
     int16x8_t diff_high_3 = vsubq_s16(v1_high_wide_3, v2_high_wide_3);
 
     int32x4_t diff_low_30 = vmovl_s16(vget_low_s16(diff_low_3));
     int32x4_t diff_low_31 = vmovl_s16(vget_high_s16(diff_low_3));
     int32x4_t diff_high_30 = vmovl_s16(vget_low_s16(diff_high_3));
     int32x4_t diff_high_31 = vmovl_s16(vget_high_s16(diff_high_3));
 
     int32x4_t square_low_30 = vmulq_s32(diff_low_30, diff_low_30);
     int32x4_t square_low_31 = vmulq_s32(diff_low_31, diff_low_31);
     int32x4_t square_high_30 = vmulq_s32(diff_high_30, diff_high_30);
     int32x4_t square_high_31 = vmulq_s32(diff_high_31, diff_high_31);
 
     sum3 = vaddq_s32(sum3, square_low_30);
     sum3 = vaddq_s32(sum3, square_low_31);
     sum3 = vaddq_s32(sum3, square_high_30);
     sum3 = vaddq_s32(sum3, square_high_31);
