...
float F_InnerProductSIMD16Ext_AVX_impl(const void *pVect1v, const void *pVect2v,
                                       const void *qty_ptr) {
...
float F_InnerProductSIMD16Ext_AVX(const void *pVect1v, const void *pVect2v, const void *qty_ptr) {
    return 1.0f - F_InnerProductSIMD16Ext_AVX_impl(pVect1v, pVect2v, qty_ptr);
}
...
float F_InnerProductSIMD16ExtResiduals_AVX(const void *pVect1v, const void *pVect2v,
    ...
    size_t qty = *((size_t *)qty_ptr);
    size_t qty16 = qty >> 4 << 4;
    float res = F_InnerProductSIMD16Ext_AVX_impl(pVect1v, pVect2v, &qty16);
