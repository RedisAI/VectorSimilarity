...
SQ8_SQ8_Precomputed_InnerProductStep_NEON_DOTPROD(const uint8_t *&pVec1, const uint8_t *&pVec2,
                                                  uint32x4_t &dot_sum) {
...
float SQ8_SQ8_Precomputed_InnerProductSIMD64_NEON_DOTPROD_IMP(const void *pVec1v,
                                                              const void *pVec2v,
                                                              size_t dimension) {
    ...
    for (size_t i = 0; i < num_of_chunks; i++) {
        SQ8_SQ8_Precomputed_InnerProductStep_NEON_DOTPROD(pVec1, pVec2, dot_sum0);
        SQ8_SQ8_Precomputed_InnerProductStep_NEON_DOTPROD(pVec1, pVec2, dot_sum1);
        SQ8_SQ8_Precomputed_InnerProductStep_NEON_DOTPROD(pVec1, pVec2, dot_sum2);
        SQ8_SQ8_Precomputed_InnerProductStep_NEON_DOTPROD(pVec1, pVec2, dot_sum3);
    }
...
template <unsigned char residual> // 0..63
float SQ8_SQ8_Precomputed_InnerProductSIMD64_NEON_DOTPROD(const void *pVec1v, const void *pVec2v,
                                                          size_t dimension) {
    return 1.0f - SQ8_SQ8_Precomputed_InnerProductSIMD64_NEON_DOTPROD_IMP<residual>(pVec1v, pVec2v,
                                                                                    dimension);
}
...
template <unsigned char residual> // 0..63
float SQ8_SQ8_Precomputed_CosineSIMD64_NEON_DOTPROD(const void *pVec1v, const void *pVec2v,
                                                    size_t dimension) {
    return 1.0f - SQ8_SQ8_Precomputed_InnerProductSIMD64_NEON_DOTPROD_IMP<residual>(pVec1v, pVec2v,
                                                                                    dimension);
}
