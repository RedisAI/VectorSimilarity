...
[![Known Vulnerabilities](https://snyk.io/test/github/RedisAI/VectorSimilarity/badge.svg?targetFile=sbin/requirements.txt)](https://snyk.io/test/github/RedisAI/VectorSimilarity?targetFile=sbin/requirements.txt)
