    ...
    if (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        if (GLIBC_2_28_FOUND)
            if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "20.0")
                set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/v0.2.0/svs-shared-library-0.2.0-reduced-clang20.tar.gz" CACHE STRING "SVS URL")
            else()
                set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/v0.2.0/svs-shared-library-0.2.0-reduced-clang.tar.gz" CACHE STRING "SVS URL")
            endif()
        else()
	    ...
	    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "14.0")
                set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/v0.2.0/svs-shared-library-0.2.0-reduced-gcc14.tar.gz" CACHE STRING "SVS URL")
            else()
                set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/v0.2.0/svs-shared-library-0.2.0-reduced.tar.gz" CACHE STRING "SVS URL")
	    endif()
        elseif(GLIBC_2_26_FOUND)
            set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/v0.2.0/svs-shared-library-0.2.0-reduced-glibc2_26.tar.gz" CACHE STRING "SVS URL")
        else()
