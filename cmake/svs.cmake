...
if(USE_SVS)
    ...
    if (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        if (GLIBC_2_28_FOUND)
            set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/v1.0.0-dev/svs-shared-library-1.0.0-NIGHTLY-20250826-reduced-clang.tar.gz" CACHE STRING "SVS URL")
        else()
        ...
        if (GLIBC_2_28_FOUND)
            set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/v1.0.0-dev/svs-shared-library-1.0.0-NIGHTLY-20250826-reduced.tar.gz" CACHE STRING "SVS URL")
        elseif(GLIBC_2_26_FOUND)
            set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/v1.0.0-dev/svs-shared-library-1.0.0-NIGHTLY-20250826-reduced-glibc2_26.tar.gz" CACHE STRING "SVS URL")
        else()
