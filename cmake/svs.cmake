    ...
    if (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        if(GLIBC_VERSION VERSION_GREATER_EQUAL "2.31" AND CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "21.0")
            if(GLIBCXX_VERSION VERSION_GREATER_EQUAL "11")
                set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/nightly/svs-shared-library-0.5.0rc2-reduced-clang21-gcc11.tar.gz" CACHE STRING "SVS URL")
            else()
        ...
        if(GLIBC_VERSION VERSION_GREATER_EQUAL "2.28")
		    ...
		    set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/nightly/svs-shared-library-0.5.0rc2-reduced-gcc14.tar.gz" CACHE STRING "SVS URL")
            else()
                set(SVS_URL "https://github.com/intel/ScalableVectorSearch/releases/download/nightly/svs-shared-library-0.5.0rc2-reduced.tar.gz" CACHE STRING "SVS URL")
            endif()
        else()
