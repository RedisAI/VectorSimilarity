...
INITIALIZE_BENCHMARKS_SET(BM_VecSimSpaces_BF16, BF16, NEON_BF16, 32, neon_supported);
#endif
#ifdef OPT_SVE_BF16
bool sve_supported = opt.svebf16; // Check for SVE support
INITIALIZE_BENCHMARKS_SET(BM_VecSimSpaces_BF16, BF16, SVE_BF16, 32, sve_supported);
#endif
#endif // AARCH64
