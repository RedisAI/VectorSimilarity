...
def main():
    ...
    for i in range(5):
        ...
        res_glove_50_ids, res_glove_50_scores = dbpedia_index.knn_query(q1, k)
        res_glove_200_ids, res_glove_50_scores = dbpedia_index.knn_query(q2, k)
        total_res = reduce(np.union1d, (res_dbpedia_ids[0], res_glove_50_ids[0], res_glove_200_ids[0]))

        # measure recall by this point
