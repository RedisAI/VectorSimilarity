...
***************************************/
// TopK BF sanity
BENCHMARK_TEMPLATE_DEFINE_F(BM_VecSimSpecialIndex, BM_FUNC_NAME(TopK, BF), bf16_index_t)
(benchmark::State &st) { TopK_BF(st); }
REGISTER_TopK_BF(BM_VecSimSpecialIndex, BM_FUNC_NAME(TopK, BF));

// TopK BF bf16
BENCHMARK_TEMPLATE_DEFINE_F(BM_VecSimSpecialIndex, BM_FUNC_NAME(TopK, FLAT_BF16), bf16_index_t)
(benchmark::State &st) { TopK_BF_special(st, special_index_offset); }
REGISTER_TopK_BF(BM_VecSimSpecialIndex, BM_FUNC_NAME(TopK, FLAT_BF16));

// TopK HNSW
BENCHMARK_TEMPLATE_DEFINE_F(BM_VecSimSpecialIndex, BM_FUNC_NAME(TopK, HNSW), bf16_index_t)
