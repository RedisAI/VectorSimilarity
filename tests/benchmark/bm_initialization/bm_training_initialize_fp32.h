...
BENCHMARK_TEMPLATE_DEFINE_F(BM_VecSimSVSTrain, BM_TrainNoCompression, fp32_index_t)
...
BENCHMARK_TEMPLATE_DEFINE_F(BM_VecSimSVSTrain, BM_TrainAsyncNoCompression, fp32_index_t)
...
BENCHMARK_TEMPLATE_DEFINE_F(BM_VecSimSVSTrain, BM_TrainCompressed, fp32_index_t)
(benchmark::State &st) { Train(st); }
...
BENCHMARK_TEMPLATE_DEFINE_F(BM_VecSimSVSTrain, BM_TrainCompressedAsync, fp32_index_t)
(benchmark::State &st) { TrainAsync(st); }
