...
DEFINE_DELETE_VECTOR(DeleteVector_BF_FP64, fp64_index_t, BruteForceIndex_Multi, double, double,
                     VecSimAlgo_BF)
DEFINE_DELETE_VECTOR(DeleteVector_HNSW_FP64, fp64_index_t, HNSWIndex_Multi, double, double,
                     VecSimAlgo_HNSWLIB)
