...
public:
    ...
    static void RunTopK_ANN(benchmark::State &st, VecSimQueryParams &query_params, size_t iter,
                            size_t k, size_t &correct, VecSimIndex *ann_index_,
