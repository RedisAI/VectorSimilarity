...
TEST_F(CommonTest, ResolveQueryRuntimeParams) {
    ...
    ASSERT_EQ(VecSimIndex_ResolveParams(index, rparams, array_len(rparams), nullptr, false, k),
    ...
    ASSERT_EQ(VecSimIndex_ResolveParams(index, rparams, 1, &qparams, true, k), VecSim_OK);
    ...
    ASSERT_EQ(VecSimIndex_ResolveParams(index, rparams + 1, 1, &qparams, false, k),
              VecSimParamResolverErr_InvalidPolicy_NHybrid);
