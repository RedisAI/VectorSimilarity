...
protected:
    ...
    BruteForceIndex_Multi<data_t, dist_t> *CastToBF_Multi(VecSimIndexRef *index) {
        return reinterpret_cast<BruteForceIndex_Multi<data_t, dist_t> *>(index->index_ref.get());
    }
};
