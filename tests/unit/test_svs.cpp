...
// 1342 points.
//
// This test drives that same two-stage sequence directly against SVSIndexBase (bypassing
// RediSearch/the tiered wrapper's threshold logic) and sweeps those observed batch sizes.
