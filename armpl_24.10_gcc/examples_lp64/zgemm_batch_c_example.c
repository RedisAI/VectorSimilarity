...
int main(void) {
	...
	int *m, *n, *k;
	m = (int*)malloc((group_count)*sizeof(int));
	n = (int*)malloc((group_count)*sizeof(int));
	k = (int*)malloc((group_count)*sizeof(int));

	int *lda, *ldb, *ldc;
	lda = (int*)malloc((group_count)*sizeof(int));
	ldb = (int*)malloc((group_count)*sizeof(int));
	ldc = (int*)malloc((group_count)*sizeof(int));
