...
#define NMAX 8
  ...
  float a[MMAX*NMAX], s[MMAX+NMAX], u[1], vt[1];
  int matrix_layout;
  ...
  printf("ARMPL example: SVD of a matrix A using sgesdd\n");
  printf("---------------------------------------------\n");
  printf("\n");
  ...
  info = LAPACKE_sgesdd(matrix_layout,'n',m,n,a,lda,s,u,1,vt,1);
