! Generated automatically.  DO NOT EDIT!
  ...
  interface
    subroutine fftw_mpi_init() bind(C, name='fftw_mpi_init_f03')
      import
...
! FFTW interface
!
    subroutine fftwf_mpi_init() bind(C, name='fftw_mpi_init_f03')
      import
    end subroutine fftwf_mpi_init

    subroutine fftwf_mpi_cleanup() bind(C, name='fftw_mpi_cleanup')
      import
    ...
    integer(C_INTPTR_T) function fftwf_mpi_local_size(rnk,n,comm,local_n0,local_0_start) bind(C, name='fftw_mpi_local_size_f03')
      import
      integer(C_INT), value :: rnk
      integer(C_INTPTR_T), dimension(*), intent(in) :: n
      integer(C_INT32_T), value :: comm
...
!    type(C_PTR) function fftwf_mpi_plan_transpose(n0,n1,in,out,comm,flags) bind(C, name='fftw_mpi_plan_transpose_f03')
!      import
!      integer(C_INTPTR_T), value :: n0
!      integer(C_INTPTR_T), value :: n1
!      real(C_DOUBLE), dimension(*), intent(out) :: in
